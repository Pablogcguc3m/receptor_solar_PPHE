...
def resolver_velocidad(rho1, mu1, cp1, k1, n1_fric, n2_fric, n3_nu, n4_nu, n5_nu,
    ...
    # Se recalcula todo el estado con la w1 definitiva: dentro del bucle, f1, U y
    # w2 quedan siempre un iterado por detras de w1, y si se sale por max_iter ese
    # desfase hace que las dos longitudes LF no coincidan.
    Re1 = Re(rho1, w1, de1, mu1)
    f1 = fI(n1_fric, Re1, n2_fric)
    Pr1 = Pr(cp1, mu1, k1)
    Nu1 = NuI(n3_nu, n4_nu, n5_nu, Re1, Pr1)
